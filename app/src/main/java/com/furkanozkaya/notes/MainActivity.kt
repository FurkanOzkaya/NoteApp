...
import com.furkanozkaya.notes.Adapter.noteListAdapter
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recylerview=findViewById<RecyclerView>(R.id.notesRecyleView)

        recylerview.layoutManager=LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false)
        recylerview.adapter= noteListAdapter(dataAccess.allNotes,this)
